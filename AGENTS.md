...
- 共享对象字段和枚举冲突，以 `01_shared_schemas.md` 为准
- 主流程责任归属冲突，以 `02_workflow_orchestration.md` 为准
- 表结构和自然幂等键冲突，以 `05_database_schema.md` 为准
...
1. 先更新 `01_shared_schemas.md`
2. 再更新 `05_database_schema.md` 中对应字段
3. 再更新相关模块文档
4. 最后更新 mock 和代码
...
先更新 `02_workflow_orchestration.md`，再修改模块设计和代码。
...
如果要把工作分给独立 Codex 线程，直接使用：

- `docs/thread_prompts/10_ingestion_thread_prompt.md`
- `docs/thread_prompts/20_rule_engine_thread_prompt.md`
- `docs/thread_prompts/30_ai_processing_thread_prompt.md`
- `docs/thread_prompts/40_decision_engine_thread_prompt.md`
- `docs/thread_prompts/50_delivery_thread_prompt.md`
- `docs/thread_prompts/60_user_profile_thread_prompt.md`
- `docs/thread_prompts/70_config_thread_prompt.md`
- `docs/thread_prompts/80_feedback_thread_prompt.md`
